...
const NUMBER_OF_PARTICLES = document.getElementById('numParticles').value;
...
class Effect {
    ...
    setupEventListeners() {
        document.getElementById('updateParticles').addEventListener('click', () => {
            this.n_particles = parseInt(document.getElementById('numParticles').value) || 1000;
            this.particles = Array.from({ length: this.n_particles }, () => new Particle(this));
            this.updateFlowField();
        });

        document.getElementById('increaseButtonZoom').addEventListener('click', () => {
        ...
        document.getElementById('increaseButtonCurve').addEventListener('click', () => {
            this.curve += 0.1;
            this.updateFlowField();
        });

        document.getElementById('decreaseButtonCurve').addEventListener('click', () => {
            this.curve = Math.max(0.1, this.curve - 0.1);
            this.updateFlowField();
        });
    }
